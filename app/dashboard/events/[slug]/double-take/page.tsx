...
export default function DoubleTakePage() {
  ...
  if (alreadyVoted || submitted) {
    return (
      <div className="text-center py-16">
        ...
        <h2 className="font-serif text-2xl font-semibold text-dark mb-3">
        ...
        <Link href="/dashboard/matches" className="text-copper font-medium hover:text-copper-dark transition-colors">
  ...
  return (
    <>
      ...
      <div className="mb-8">
        <p className="text-xs uppercase tracking-[0.15em] text-copper font-medium mb-2">
          Double Take
        </p>
        <h1 className="font-serif text-2xl md:text-3xl font-semibold text-dark mb-2">
          Who caught your eye?
        </h1>
      ...
      {attendees.length === 0 ? (
        <div className="bg-white rounded-2xl p-8 border border-gray-100 text-center">
          <p className="text-muted">No other attendees to show yet.</p>
        </div>
      ) : (
        <>
            ...
            {attendees.map((attendee) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="font-semibold text-dark text-sm">{attendee.first_name}</p>
          ...
          <div className="sticky bottom-20 md:bottom-4">
            <motion.button
              ...
              className={`w-full py-4 rounded-xl font-semibold text-base tracking-wide transition-all shadow-lg cursor-pointer ${
                selected.size > 0
                  ? "bg-copper text-white hover:bg-copper-dark shadow-copper/15"

...
export default function DashboardEventPage() {
  ...
  if (!event) {
    return (
      <div className="text-center py-20">
        <h1 className="font-serif text-3xl font-semibold text-black mb-4">Event not found</h1>
        <Link href="/dashboard" className="text-gold font-medium hover:text-gold transition-colors">
          Back to dashboard
        </Link>
      </div>
    );
  ...
  return (
    <>
      <Link href="/dashboard" className="inline-flex items-center gap-2 text-stone hover:text-black text-sm font-medium transition-colors mb-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            {!attending ? (
              <motion.button
                ...
                className="flex-1 py-4 rounded-xl bg-gold text-white font-semibold text-base tracking-wide transition-colors hover:bg-gold cursor-pointer shadow-lg shadow-gold/15 disabled:opacity-50"
              >
              ...
              <>
                ...
                {event.double_take_open && (
                  <Link
                    ...
                    className="flex-1 py-4 rounded-xl bg-gold text-white font-semibold text-base text-center tracking-wide hover:bg-gold transition-colors shadow-lg shadow-gold/15"
                  >
                    Open Double Take
                  </Link>
                )}

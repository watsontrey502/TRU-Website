    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-6 pb-24">
        <div className="text-center py-16">
          ...
          <h1 className="font-serif text-2xl font-semibold text-black mb-2">Selections locked in!</h1>
          <p className="text-stone font-sans mb-6 max-w-xs mx-auto">
          ...
          <motion.button
            ...
            className="inline-block px-8 py-3.5 rounded-xl bg-gold text-white font-sans font-semibold hover:bg-gold transition-colors cursor-pointer shadow-lg shadow-gold/15"
          >
            View Your Matches
          </motion.button>
        </div>
  ...
  return (
    <div className="min-h-screen pt-14 pb-32 px-6">
      <div className="max-w-2xl mx-auto pt-6">
        {/* Back button */}
        <Link href="/demo/event" className="inline-flex items-center gap-2 text-stone hover:text-black text-sm font-medium transition-colors mb-6">
        ...
        <div className="text-center mb-8">
          <h1 className="font-serif text-2xl font-semibold text-black mb-2">Double Take</h1>
            ...
            return (
              ...
              >
                ...
                <div className={`w-14 h-14 rounded-full flex items-center justify-center transition-colors ${
                  isSelected ? "bg-gold text-white" : "bg-gray-100"
                }`}>
                ...
                <span className={`text-sm font-sans font-medium ${isSelected ? "text-black" : "text-stone"}`}>
                  {a.first_name}
                </span>

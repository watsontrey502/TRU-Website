    ...
    <div className="min-h-screen pt-14 pb-24 px-6">
      <div className="max-w-2xl mx-auto pt-6">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="font-serif text-3xl font-semibold text-black mb-2">Your Matches</h1>
        ...
        {DEMO_MATCHES.length > 0 ? (
          <section>
            ...
            >
              ...
              <h2 className="text-sm font-semibold text-stone uppercase tracking-wide font-sans">
                {DEMO_EVENT.name}
              </h2>
            </motion.div>
          ...
          >
            ...
            <p className="text-stone text-sm font-sans max-w-xs mx-auto">

...
function OAuthButtons({ variant, onOAuth }: { variant: "light" | "dark"; onOAuth: (provider: "google" | "apple") => void }) {
  ...
  return (
    <div className="space-y-3">
      <button type="button" onClick={() => onOAuth("google")} className={btnClass}>
      ...
      <button type="button" onClick={() => onOAuth("apple")} className={btnClass}>
...
function Divider({ variant }: { variant: "light" | "dark" }) {
  return (
      ...
      <div className="min-h-screen bg-cream">
        ...
        <div className="hidden md:grid md:grid-cols-2 min-h-screen">
          ...
          <div className="bg-cream flex items-center justify-center">
            <div className="w-full max-w-md mx-auto px-6 py-16">
              ...
              <OAuthButtons variant="light" onOAuth={handleOAuth} />
              <Divider variant="light" />

              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label htmlFor="email-desktop" className="flex items-baseline gap-1.5 text-sm font-medium text-gray-600 mb-2">
                    Email
                  </label>
                  <input
                    id="email-desktop"
                ...
                <div>
                  <label htmlFor="password-desktop" className="flex items-baseline gap-1.5 text-sm font-medium text-gray-600 mb-2">
                    Password
                  </label>
        ...
        <div className="md:hidden px-5 py-8 pb-16">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="password-mobile" className="flex items-baseline gap-1.5 text-sm font-medium text-gray-600 mb-2">
                Password
              </label>
              <div className="relative">
                <input
